...
const pegarGestores = async () => {
  try {
    const response = await axios.get('http://cursophp.com/gestaoDeTarefas-master/src/backend/controllers/selectGestor.php');
...
const criarEquipe = async () => {
  try {
    const response = await axios.post('http://cursophp.com/gestaoDeTarefas-master/src/backend/controllers/addEquipe.php', {
