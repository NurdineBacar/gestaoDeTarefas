        ...
        <div class="modal-body">
          <div class="row px-2">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select v-model="perfil_acesso" class="custom-select">
...
onMounted(async () => {
  try {
    const response = await axios.get('http://cursophp.com/gestaoDeTarefas-master/src/backend/controllers/listPerfil.php');
...
const criarColaborador = async () => {
  gerarSenha();
  try {
    const response = await axios.post('http://cursophp.com/gestaoDeTarefas-master/src/backend/controllers/addColaborador.php', {
      senha: senha.value,
