<template>
   <div class="py-3 px-2 position-relative" id="box">
        <h2 class="ms-2 mb-3">LOGO</h2>

        <inputs input-type="search" pholder="Pesquisar" icon="fa-solid fa-home" class="mb-3 "/>
        ...
        <div class="d-flex flex-column gap-1 mt-1">
            ...
            <router-link to="/complaints" class="navlink d-flex justify-content-between px-2 py-2 rounded">
                <div>
            ...
            <router-link to="/comunicates" class="navlink d-flex justify-content-between px-2 py-2 rounded">
                <div>
            ...
            <router-link to="/collaborators" class="navlink d-flex justify-content-between px-2 py-2 rounded">
                <div>
        ...
        <div class="position-absolute bottom-0 mb-2" id="lower-box">
            <a href="" class="fs-6 ms-2 fw-semibold" id="support"><i class="fa-solid fa-home me-1"></i> Suporte</a>
...
import inputs from "./inputs/input.vue";
